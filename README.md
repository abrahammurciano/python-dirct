...
```sh
find ./ -type f -exec sed -i -e "s/dirct/$PACKAGE/g" {} \;
find ./ -type f -exec sed -i -e "s/dirct/$MODULE/g" {} \;
find ./ -type f -exec sed -i -e "s/A dict that reflects the contents of a directory./$PACKAGE_DESCRIPTION/g" {} \;
...
find ./ -type f -exec sed -i -e "s/3.11/$MIN_PYTHON_VERSION/g" {} \;
```
